package com.tns.JPAQuiresClient;

import com.JPA.Services.BookService;
import com.JPA.Services.BookServiceImpl;
import com.tns.JPAcrud1.entites.Book;

public class Client {

	public static void main(String[] args) {

		BookService service = (BookService) new BookServiceImpl();
